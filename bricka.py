...
class Bricka:
    ...
    def check_input(self, ptx, pty):
        ...
        if pty<10  and pty!=0 and self.state == STATE_BALL_IN_PADDLE:
            self.ball_vel = [20,-20]
    ...
    def run(self):
       for fingerPnt in HDF.mainHandDet():
            global ptX
            global ptY
            ptX = fingerPnt[0]
            ptY = fingerPnt[1]            
